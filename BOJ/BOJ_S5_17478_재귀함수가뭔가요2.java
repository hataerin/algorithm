...
public class BOJ_S5_17478_재귀함수가뭔가요2 {
    ...
    public static void solve(String blank, int N){
        //기저조건
        if (N == 0) {
            System.out.println(blank + B);
            System.out.println(blank + D);
        ...
        //유도파트
        System.out.println(blank + B);
        System.out.println(blank + C1);
        System.out.println(blank + C2);
        System.out.println(blank + C3);
        solve( blank+"____", N-1);
        System.out.println(blank + E);
    ...
    static String C1 = "\"잘 들어보게. 옛날옛날 한 산 꼭대기에 이세상 모든 지식을 통달한 선인이 있었어.";
